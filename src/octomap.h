...
public:
        ...
        // find the corridor for given goal and start
        std::pair<Eigen::MatrixXd, Eigen::MatrixXd>
            getPath(
                    const double src[_TOT_DIM], 
                    const double dest[_TOT_DIM]);
        ...
        // find the corridor for given polynomial trajectory
        bool retPathFromTraj(
